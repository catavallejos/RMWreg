...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(HiddenLogPriorTheta(theta, gam, a, type, mixing));
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(HiddenRMWreg_MCMC(N, thin, burn, Time, Event, X, mixing, Hyp1Gam, Hyp2Gam, PriorCV, HypTheta, beta0, gam0, theta0, Adapt, ar, StoreAdapt, EndAdapt, LSbeta0, LSgam0, LStheta0, FixBetaJ, FixGam, FixTheta, PrintProgress, lambdaPeriod, FixLambdaI, RefLambda));
    return rcpp_result_gen;
END_RCPP
}
// HiddenLogLik
...
BEGIN_RCPP
    ...
    rcpp_result_gen = Rcpp::wrap(HiddenLogLik(Time, Event, DesignMat, beta, gam, theta, Mixing, BaseModel));
    return rcpp_result_gen;
END_RCPP
}
// HiddenRMWreg_DIC
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< String const& >::type Mixing(MixingSEXP);
    Rcpp::traits::input_parameter< String const& >::type BaseModel(BaseModelSEXP);
    rcpp_result_gen = Rcpp::wrap(HiddenRMWreg_DIC(Chain, Time, Event, DesignMat, Mixing, BaseModel));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< String const& >::type Mixing(MixingSEXP);
    Rcpp::traits::input_parameter< String const& >::type BaseModel(BaseModelSEXP);
    rcpp_result_gen = Rcpp::wrap(HiddenRMWreg_CaseDeletion(Chain, Time, Event, DesignMat, Mixing, BaseModel));
    return rcpp_result_gen;
END_RCPP
}
...
BEGIN_RCPP
    ...
    Rcpp::traits::input_parameter< int >::type lambdaPeriod(lambdaPeriodSEXP);
    Rcpp::traits::input_parameter< double >::type ar(arSEXP);
    rcpp_result_gen = Rcpp::wrap(HiddenRMWreg_BFoutlierObs(Chain, Obs, RefLambda, Time, Event, DesignMat, PriorCV, HypTheta, Hyp1Gam, Hyp2Gam, Mixing, BaseModel, thin, lambdaPeriod, ar));
    return rcpp_result_gen;
END_RCPP
}
